...
namespace PigeonCms.Shop.OrdersProvider
{
    public class CurrentOrder
    {
        ...
        private CookiesManager ckMan = new CookiesManager(COOKIE_NAME);
        private OrdersManager ordMan = new OrdersManager();
        private OrderRowsManager rowMan = new OrderRowsManager(); 
