/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-apng-appearance-applicationcache-audio-audioloop-audiopreload-backdropfilter-backgroundblendmode-backgroundcliptext-backgroundsize-bgpositionshorthand-bgpositionxy-bgrepeatspace_bgrepeatround-bgsizecover-borderimage-borderradius-boxshadow-boxsizing-canvas-canvasblending-canvastext-canvaswinding-checked-contenteditable-contextmenu-cookies-cryptography-cssall-cssanimations-csscalc-csschunit-csscolumns-cssescape-cssexunit-cssfilters-cssgradients-csshyphens_softhyphens_softhyphensfind-cssinvalid-cssmask-csspointerevents-csspositionsticky-csspseudoanimations-csspseudotransitions-cssreflections-cssremunit-cssresize-cssscrollbar-csstransforms-csstransforms3d-csstransitions-cssvalid-cssvhunit-cssvmaxunit-cssvminunit-cssvwunit-cubicbezierrange-customevent-customprotocolhandler-dataview-directory-display_runin-displaytable-ellipsis-fileinput-flexbox-flexboxlegacy-flexboxtweener-flexwrap-fontface-formattribute-formvalidation-fullscreen-generatedcontent-geolocation-getrandomvalues-hashchange-history-hsla-inlinesvg-inputtypes-jpeg2000-jpegxr-localizednumber-localstorage-mediaqueries-multiplebgs-notification-nthchild-opacity-overflowscrolling-pagevisibility-placeholder-pointerevents-postmessage-preserve3d-regions-rgba-sessionstorage-shapes-siblinggeneral-sizes-smil-srcset-subpixelfont-supports-svg-svgasimg-svgclippaths-svgfilters-svgforeignobject-target-textalignlast-textshadow-todataurljpeg_todataurlpng_todataurlwebp-touchevents-userselect-vibrate-video-videoautoplay-videoloop-videopreload-webaudio-webgl-webglextensions-webp-webpalpha-webpanimation-webplossless_webp_lossless-websqldatabase-willchange-wrapflow-addtest-atrule-domprefixes-fnbind-hasevent-mq-prefixed-prefixedcss-prefixes-setclasses-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
