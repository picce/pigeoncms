<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" ValidateRequest="false" 
    MasterPageFile="~/pgn-admin/masterpages/PigeonModernBlank.master"
    Title="{PigeonCms} - Installation wizard" Inherits="Installation_Default" %>
...
<ContentTemplate>
	...
	<div class="big-title-wizard--wrapper">
		<img src="../masterpages/PigeonModern/img/logo.svg" />
		<h1 class="big-title-wizard">Installation wizard</h1>
	</div>

	<div class="background-wizard">
					...
					<div class="panel-body"> 
						<div class="pull-right">
							<div class="btn-group adminToolbar">
								<asp:Button ID="BtnPrevious" runat="server" Text="Previous" CssClass="btn btn-default btn-modern btn-modern--cancel btn-modern--wizard btn-modern--wizard-cancel" OnClick="BtnPrevious_Click" />
								<asp:Button ID="BtnNext" runat="server" Text="Next" CssClass="btn btn-primary btn-modern btn-modern--wizard" OnClick="BtnNext_Click" />
							</div>
						</div> 
					</div>
				</div>
					...
					<div class="panel-body"> 
						...
						<asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0" OnActiveViewChanged="MultiView1_ActiveViewChanged">
							...
							<asp:View ID="ViewSystem" runat="server">
								...
								<h2 class="middle-title-wizard">Step: System check</h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body panel-body--wizard">
									<%=ServerVariables %>
									</div>
								</div>
							...
							<asp:View ID="ViewDatabase" runat="server">
								...
								<h2 class="middle-title-wizard">Step: Database settings</h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body panel-body--wizard">
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtConnectionName" Text="default" MaxLength="50" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtHostName" Text="(local)" MaxLength="50" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtDbName" Text="pigeondb" MaxLength="50" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtUserId" Text="" MaxLength="50" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">
												database user
											</div>
										</div>
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtPassword" Text="" MaxLength="50" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">
												database password
											</div>
										</div>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body panel-body--wizard">
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtTablesPrefix" Text="pgn_" MaxLength="50" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">
										...
										<div class="form-group col-lg-12">
											<div class="checkbox-container checkbox-wizard">
							...
							<asp:View ID="ViewSite" runat="server">
								...
								<h2 class="middle-title-wizard">Step: Site info</h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtSiteTitle" Text="" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtEncryptKey" Text="" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="TxtAdminPassword" Text="" MaxLength="50" runat="server" CssClass="form-control-wizard"></asp:TextBox>
											<div class="well well-sm">administrator's password</div>
										</div>
                                                 
										<div class="form-group col-lg-12">
											<%=PigeonCms.Utility.GetLabel("", "e-mail", TxtEmail)%>
											<asp:TextBox ID="TxtEmail" Text="" MaxLength="50" runat="server" CssClass="form-control-wizard"></asp:TextBox>
							...
							<asp:View ID="ViewSummary" runat="server">
								...
								<h2 class="middle-title-wizard">Step: Settings summary</h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group col-lg-12">
											...
											<asp:TextBox ID="LitConnString"  Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "tables prefix")%>
											<asp:TextBox ID="LitTablesPrefix" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "backup old tables")%>
											<asp:TextBox ID="LitBackupTables" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "install example data")%>
											<asp:TextBox ID="LitInstallExampleData" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "site title")%>
											<asp:TextBox ID="LitSiteTitle" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "site url")%>
											<asp:TextBox ID="LitSiteUrl" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "encryption key")%>
											<asp:TextBox ID="LitEncryptKey" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "admin user")%>
											<asp:TextBox ID="LitAdminUser" Text="admin" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "admin password")%>
											<asp:TextBox ID="LitAdminPassword" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>

										<div class="form-group col-lg-12">
											<%=Utility.GetLabel("", "email")%>
											<asp:TextBox ID="LitEmail" Enabled="false" CssClass="form-control-wizard" runat="server"></asp:TextBox>
										</div>
							...
							<asp:View ID="ViewFinish" runat="server">
								...
								<h2 class="middle-title-wizard">Installation completed</h2>

								<div class="panel panel-default">
									<div class="panel-body p-wizard">
										<p>
