...
public partial class Installation_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string installFileName = "~/Installation/Install.txt";
    ...
    private bool parseData()
    {
        ...
        string filePath = HttpContext.Current.Request.MapPath("~/Installation/sql/");
    ...
    private bool setData()
    {
        ...
        try
        {
            ...
            TextReader tr = new StreamReader(
                HttpContext.Current.Request.MapPath("~/Installation/sql/create.sql"));
            sSql = tr.ReadToEnd();
            tr.Close();
            ...
            //bulk data
            tr = new StreamReader(
                HttpContext.Current.Request.MapPath("~/Installation/sql/bulk.sql"));
            sSql = tr.ReadToEnd();
            tr.Close();
            sSql = Database.ParseSql(sSql, TxtTablesPrefix.Text);
            sResult = Database.ExecuteQuery(myRd, myCmd, sSql);
        ...
        if (res)
        {
            ...
            {
                string installFileName = "~/Installation/Install.txt";
                string renamedInstallFileName = "~/Installation/Install_completed.txt";
                installFileName = HttpContext.Current.Request.MapPath(installFileName);
            ...
            {
                LblErr.Text += "Error renaming 'install.txt' file, please rename manually in '/Installation/Install_completed.txt'.<br />";
                LblErr.Text += ex.Message + "<br />";
            }
        }
