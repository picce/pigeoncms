                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="Grid1" runat="server" AllowPaging="True" AllowSorting="false" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ValidFrom" HeaderText="Valido dal " ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />

                                <asp:BoundField DataField="ValidTo" HeaderText="Valido al" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />
