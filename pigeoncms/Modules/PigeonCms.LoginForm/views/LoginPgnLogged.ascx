<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LoginPgnLogged.ascx.cs" Inherits="Controls_LoginPgnLogged" %>

<div class='moduleBody <%=base.BaseModule.CssClass %>'>
<ul class='bar <%=base.BaseModule.CssClass %>'>
<li>
    <%=base.GetLabel("user", "user", TxtUser)%>
    <asp:TextBox id="TxtUser" ValidationGroup="AdminArea" CssClass="mandatory" runat="server"></asp:TextBox>
...
<li>
    ...
    <asp:TextBox id="TxtPassword" TextMode="Password" ValidationGroup="AdminArea" CssClass="mandatory" runat="server"></asp:TextBox>
